...
urlpatterns = [
    ...
    path('edit/', views.edit_excel_data, name='edit_excel_data'), #mao ne na lines napuno
    path('update/<int:pk>/', views.update_excel_data, name='update_excel_data'),  #asta ne
    #ALUMNI
   ...
   path('Gen_TECHNOCRATS_viewofficer', views.Gen_TECHNOCRATS_viewofficer, name="Gen_TECHNOCRATS_viewofficer"),
    ...
    path("counseling_schedule_admin/",counseling_schedule_admin,name="counseling_schedule_admin",),
    path("counselor_scheduler/",counselor_scheduler,name="counselor_scheduler",),
    ...
    path("daily_montly_guidance_transaction/", daily_montly_guidance_transaction, name="daily_montly_guidance_transaction"),
    path("show_transaction_specific_date/", show_transaction_specific_date, name="show_transaction_specific_date"),
    path("sort_counseling_app_admin_view/", sort_counseling_app_admin_view, name="sort_counseling_app_admin_view"),
    path("sort_exit_interview_admin_view/", sort_exit_interview_admin_view, name="sort_exit_interview_admin_view"),
