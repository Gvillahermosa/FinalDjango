...
from .models import studentInfo,RequestedGMC,Schedule,Equipment,ProcurementItem,BorrowingRecord
...
class OfficerAdmin(admin.ModelAdmin):
    list_display = ('surname','student_id','Officer_profile_picture','firstname','middlename','organization','course', 'year', 'status')

class AdviserAdmin(admin.ModelAdmin):
    list_display=('surname','Adviser_profile_picture', 'firstname', 'middlename', 'department', 'status')

class ProjectAdmin(admin.ModelAdmin):
    list_display = ['project_id', 'objective', 'org', 'target', 'involved_officer', 'p_budget', 'expected_output', 'actual_accomplishment', 'remarks', 'status', 'date_saved']
    
class FinancialStatementAdmin(admin.ModelAdmin):
    list_display = ['financial_id', 'date', 'purpose', 'source_of_funds', 'org', 'amount', 'remarks', 'status', 'date_saved']
...
class ProcurementItemAdmin(admin.ModelAdmin):
    list_display = ('itemid', 'item', 'quantity', 'unit', 'estimated_budget', 'mode_of_procurement', 'unit_price', 'status')
...
class ExcelDataAdmin(admin.ModelAdmin):
    list_display = (
        'id', 'title_of_l_d', 'frequency', 'category',
        'expected_number_of_participants', 'duration',
        'registration_fees', 'travelling_expenses',
        'planned_total_budget', 'actual_total_budget',
        'variance', 'admin_remarks'  
    )
    ordering = ('id',)
